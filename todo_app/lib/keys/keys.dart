...
class Todo {
  ...
  //var: initial value of variable can be changed
  //final: initial value of variable CANNOT be changed but can be modified if it is a list/map
  //const: object rendered unmodifable behind the scene
...
class _KeysState extends State<Keys> {
  ...
  List<Todo> get _orderedTodos {  //makes a copy of the list
    final sortedTodos = List.of(_todos);
    sortedTodos.sort((a, b) { //modify copied list so original remains unchanged
